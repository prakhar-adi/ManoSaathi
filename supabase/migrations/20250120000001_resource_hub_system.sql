-- Resource Hub System Migration
-- Creates tables for multimedia mental health resources
...
-- Create user resource interactions table (bookmarks, ratings, progress)
...
-- Create resource tags table for better categorization
...
-- Create many-to-many relationship between resources and tags
...
-- RLS Policies for user_resource_interactions
...
('Traditional Wellness Practices', 'Traditional and cultural wellness approaches', 'Lotus', '#84CC16')
ON CONFLICT (name) DO NOTHING;

-- Insert default resource tags
